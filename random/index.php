...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    ...
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;">http://api.ni-co.cn/random/api.php</a><br/>
		# 参数 #<br/>
		<li>type //type=pc为电脑壁纸/pe为手机壁纸，留空默认输出pc</li>
		<hr>
		# 返回数据 #<br/>
		...
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank">http://api.ni-co.cn/random/api.php?type=pc</a>
		</h3>
          </div>
</div>
</html>